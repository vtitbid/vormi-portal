...
class UpdateTaskCommand : Command, KoinComponent {

    override val qualifier = named("update-task-command")

    override val name = "update"

    override val description = "Обновить данные о волонтёрской задаче"
